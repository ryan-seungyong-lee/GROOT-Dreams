#!/bin/bash
#SBATCH --job-name="cosmos_pnp_can_preprocess"
#SBATCH --gpus=1
#SBATCH --array=0
#SBATCH --nodes=1
...
# ============================================================
# Cosmos Generated Data Preprocessing Pipeline - PNP Can into Bowl
# ============================================================
# 
# This script processes cosmos-generated videos for pnp_can_into_bowl task.
# Steps:
...
TASK_NAME="pnp_can_into_bowl"
INSTRUCTION="pick up the can and place it into the white bowl"
SOURCE_VIDEO_DIR="/storage1/sjw_dataset/dataset/Allex/generated/cosmos-generated-for-allex-icml/${TASK_NAME}/videos/bestofn_5"
