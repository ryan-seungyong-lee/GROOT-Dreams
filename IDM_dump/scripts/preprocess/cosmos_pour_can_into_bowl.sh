#!/bin/bash
#SBATCH --job-name="cosmos_pour_can_preprocess"
#SBATCH --gpus=1
#SBATCH --array=0
#SBATCH --nodes=1
...
# ============================================================
# Cosmos Generated Data Preprocessing Pipeline - Pour Can into Bowl
# ============================================================
# 
# This script processes cosmos-generated videos for pour_can_into_bowl task.
# Steps:
...
TASK_NAME="pour_can_into_bowl"
INSTRUCTION="pour from the can into the white bowl"
