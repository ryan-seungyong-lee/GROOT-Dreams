#!/bin/bash
# Step 2: 20K -> 40K (diversity 2.0x of 10K) for rldx_g0 v2v+i2i dataset
# Requires 20K to be built first (scaleup_rldx_g0_20K.sh)
set -e
...
echo "=== 20K -> 40K (diversity 2.0x of 10K, V2V:I2I=1:2) ==="
